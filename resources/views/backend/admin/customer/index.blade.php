...
@section('content')
@include('backend.admin.layouts.partials.headersection',['title'=>'All Customers'])
<div class="row">
                ...
                <table class="table">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td><a href="{{ url('/admin/user/profile/view/'.$user->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a></td>
                            </tr>
                        @endforeach
					</tbody>
				</table>
