    ...
    <div class="row" id="category_body">
        <div class="col-lg-8 col-md-8">
            <div class="card">
                <div class="card-body">
                    <h4>Add new Blog</h4>
                    <form id="basicform" method="post" action="{{ route('admin.blog.store') }}">
                        @csrf
                        <div class="custom-form">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control " cols="30" rows="10" placeholder="Blog full description" id="description" maxlength=""></textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group mt-20">
                                <button class="btn btn-primary col-12" type="submit">{{ __('Add New Blog') }}</button>
                            </div>
                        </div>
