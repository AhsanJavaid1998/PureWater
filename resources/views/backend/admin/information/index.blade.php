                    ...
                    <div class="col-xs-12 ">
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="true"><small>Contact</small></a>
                                <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false"><small>About</small></a>
                                    ...
                                    <form method="post" class="basicform" action="{{ route('admin.information.about.store') }}">
                                        ...
                                        <div class="custom-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control " cols="30" rows="10" placeholder="Full description" id="description" maxlength="">{{$a_json->description ?? ''}}</textarea>
                                            </div>
