...
@section('content')
@include('backend.admin.layouts.partials.headersection',['title'=>'All Teams'])
<div class="row">
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="float-right">
                    <button type="button" class="btn btn-primary mt-1 ml-1" onclick="document.location='{{route('admin.team.create')}}'">{{ __('Add New') }}</button>
...
{{--					</form>--}}
				...
				<div class="float-left">
					<form id="basicform" method="post" action="{{ route('admin.team.destroy') }}">
						@csrf
						<div class="d-flex">
					...
					<table class="table text-capitalize">
						<thead>
							<tr>
                                ...
                                <th class="am-title">{{ __('Team ID') }}</th>
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="{{ url('/admin/team/view/'.$data->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a></td>
							</tr>
						@endforeach
					</tbody>
				</table>
