...
@section('content')
@include('backend.admin.layouts.partials.headersection',['title'=>'All Supervisors'])
<div class="row">
                ...
                <table class="table">
						<thead>
							<tr>
                                ...
                                <th class="am-title">{{ __('Supervisor ID') }}</th>
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td><a href="{{ url('/admin/supervisor/profile/view/'.$user->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
				</table>
