...
@section('content')
@include('backend.admin.layouts.partials.headersection',['title'=>"All FAQ's"])
<div class="row">
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="float-right">
                    <button type="button" class="btn btn-primary mt-1 ml-1" onclick="document.location='{{route('admin.faq.create')}}'">{{ __('Add New') }}</button>
...
{{--					</form>--}}
				...
				<div class="float-left">
					<form id="basicform" method="post" action="{{ route('admin.faq.destroy') }}">
						@csrf
						<div class="d-flex">
					...
					<table class="table text-capitalize">
						<thead>
							<tr>
                                ...
                                <th class="am-title">{{ __('FAQ ID') }}</th>
...
<td>
								...
								<td><a href="{{ url('/admin/faq/view/'.$data->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a></td>
							</tr>
						@endforeach
					</tbody>
				</table>
