...
{{--                <center> <span class="text-danger text-center"><b>{{ __('Note :') }}</b> {{ __('This Section For Developer Only & Dont Use Any Kind Of Space In This Input Feild Otherwise Site Will Be Down') }}</span></center>--}}
                <div id="tabs">
                    <div class="col-xs-12 ">
                             <form method="post" class="basicform" action="{{ route('admin.information.header.store') }}">
                                        @csrf
                                        ...
                                        <div class="custom-form">
                                            <div class="single-area">
                                                <div class="card sub">
                                                    <div class="card-body">
                                                        <h5><a href="#" data-toggle="modal" data-target=".media-single" class="text-dark">Site Header Image</a></h5>
                                                        <hr>
                                                        ...
                                                        <label for="files">
                                                            ...
                                                            @if($header->content != Null)
                                                                <img class="img-fluid" id="preview" src="{{asset('uploads/images/'.$header->content)}}">
                                        ...
                                        <button class="btn btn-primary col-12" type="submit">Change Site Header</button>
                            </form>
                        </div>
                </div>
            </section>
